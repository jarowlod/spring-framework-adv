...
import static pl.training.payments.adapters.commons.Annotations.doForArgument;
...
public class MinLengthValidator {
    ...
    public void validate(JoinPoint joinPoint) throws Throwable {
        doForArgument(joinPoint, MinLength.class, (String argument, MinLength minLength) -> {
